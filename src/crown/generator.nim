...
proc generateRoutesCode*(appDir: string): string =
  ...
  for e in entries:
    for methodTuple in e.methods:
      ...
      code &= &"      elif type({e.importName}.{m}(req, {explicitArg})) is Component:\n"
      code &= &"        res = htmlResponse(${e.importName}.{m}(req, {explicitArg}))\n"
      code &= &"      elif type({e.importName}.{m}(req, {explicitArg})) is Future[Component]:\n"
      ...
      code &= &"      elif type({e.importName}.{m}(req)) is Component:\n"
      code &= &"        res = htmlResponse(${e.importName}.{m}(req))\n"
      code &= &"      elif type({e.importName}.{m}(req)) is Future[Component]:\n"
      ...
      code &= &"      elif type({e.importName}.{m}(c, p)) is Component:\n"
      code &= &"        res = htmlResponse(${e.importName}.{m}(c, p))\n"
      code &= &"      elif type({e.importName}.{m}(c, p)) is Future[Component]:\n"
  ...
  if hasNotFound:
    ...
    code &= &"      elif type({notFoundEntry.importName}.page(req, \"\")) is Component:\n"
    code &= &"        res = htmlResponse(${notFoundEntry.importName}.page(req, \"\"))\n"
    code &= &"      elif type({notFoundEntry.importName}.page(req, \"\")) is Future[Component]:\n"
    ...
    code &= &"      elif type({notFoundEntry.importName}.page(c, p)) is Component:\n"
    code &= &"        res = htmlResponse(${notFoundEntry.importName}.page(c, p))\n"
    code &= &"      elif type({notFoundEntry.importName}.page(c, p)) is Future[Component]:\n"
